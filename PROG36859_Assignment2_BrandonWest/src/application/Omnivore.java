 ...
 * @author Brandon West
 * File: Omnivore.java
 * This class is a subclass of Animal, extends
 * Animal
 *  Other Files:
 * 	- Bird.java
 * 	- Wolf.java
...
{
	/**
	 * Non-Default Constructor for Omnivore
	 ...
	 */
	public Omnivore ( String newName, double newWeight, int newScore, double newSpeed )
	{
