...
{
	/**
	 * Constuctor for wolf object
	 * @param newName name of the object
	 * @param newWeight weight of the object
	 * @param newScore score of this object
	 * @param newSpeed speed of the object
	 */
	public Wolf ( String newName, double newWeight, int newScore, double newSpeed )
	{
